...
```{r}
load(here::here('data/garden/lookit/all_children_identifiable2024-01-05.RData'))
```
...
```{r}
roar_data = read_csv(here::here('data/garden/lookit/vocab-garden-trials-122723.csv')) %>%
