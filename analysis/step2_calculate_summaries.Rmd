...
```{r}
load(here::here('data/preprocessed/all_children_identifiable2024-07-29.RData'))
```
...
write_csv(roar_summary_by_child_id, file=here::here('data/output/summary_by_child_id.csv'))
```
...
Save out data file
```{r}
write_csv(all_garden_roar_data_with_age, file=here::here('data/preprocessed/all_garden_roar_data_with_age.csv'))
```
